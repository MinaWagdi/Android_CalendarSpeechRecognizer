...
public class DBAdapter {
    ...
    public static final int COL_DayNum = 4;
    public static final int COL_Year = 5;
    public static final int COL_Time = 6;

    // [TO_DO_A4]
    // Update the ALL-KEYS string array
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_EventName, KEY_Day, KEY_Month,KEY_DayNum,KEY_Year,KEY_Time};
    ...
    private static final String DATABASE_CREATE_SQL =
            "create table " + DATABASE_TABLE
                    ...
                    + KEY_DayNum    + " string not null, "
                    + KEY_Year    + " string not null, "
    ...
    public long insertRow(String name, String day, String month, String daynum, String year, String time) {
        // [TO_DO_A8]
        ...
        initialValues.put(KEY_DayNum, daynum);
    ...
    public boolean updateRow(long rowId,String name, String day, String month, String daynum, String year, String time) {
        String where = KEY_ROWID + "=" + rowId;
        ...
        newValues.put(KEY_EventName, name);
        newValues.put(KEY_Day, day);
        newValues.put(KEY_Month, month);
        newValues.put(KEY_DayNum, daynum);
